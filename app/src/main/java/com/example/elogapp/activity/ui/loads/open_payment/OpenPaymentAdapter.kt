...
class OpenPaymentAdapter(private val mContext : Context,
                         private val fromScreenOpenPayment: Boolean,
                         private val values: List<Data>,
                         private val clickListener: (Data) -> Unit

    ) :
    RecyclerView.Adapter<OpenPaymentAdapter.ViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.fragment_open_payment_list_item, parent, false)
