...
//import com.example.elogapp.db.Driver
//
//class CustomDropDownAdapter(val context: Context, var dataSource: List<Driver>) : BaseAdapter() {
...
//        }
//        vh.label.text = dataSource.get(position).dName
//
//
//
//        return view
