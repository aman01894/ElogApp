...
class OpenLoadListAdapter(private val mContext : Context,
    private val values: List<Data>,
    private val clickListener: (Data) -> Unit,

    ) :
    RecyclerView.Adapter<OpenLoadListAdapter.ViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.fragment_open_list_item, parent, false)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        var dis = values[position].totalMiles
        ...
        try {
            ...
            for(consignee in values[position].consignees){
                addConsignee(holder.layPickup, consignee)
            }
            for(shipper in values[position].shippers){
                addShipper(holder.layDrop, shipper)
            }
    ...
    inner class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        val layPickup : LinearLayout = view.findViewById(R.id.lay_pickup)
        val layDrop : LinearLayout = view.findViewById(R.id.lay_drop)
