...
class ClosedLoadsListAdapter(private val mContext : Context,
                             private val values: List<Data>,
                             private val clickListener: (Data) -> Unit,
    ) :
    RecyclerView.Adapter<ClosedLoadsListAdapter.ViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.fragment_closeloads_list_item, parent, false)
    ...
    private fun addShipper(view: View, shipper: Shippers) {
        ...
        val view : ViewGroup = inflater.inflate(R.layout.address_closed_load, viewGroup, false) as ViewGroup
    ...
    private fun addConsignee(view: View, consignee: Consignees) {
        ...
        inflate(R.layout.address_closed_load, viewGroup, false) as ViewGroup
        val tvTitle : TextView = view.findViewById (R.id.textLocation)
